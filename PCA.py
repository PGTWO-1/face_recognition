...
if __name__ == "__main__":
    ...
    faceCascade.load("D:\python\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
    # 打开视频捕获设备
    ...
    while True:
        ...
        if cv.waitKey(25) & 0xFF == ord('q'):
            ...
            cv.imwrite('D:\\Desktop\\test.jpg',img_new)
            break
